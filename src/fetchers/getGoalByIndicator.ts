 ...
 */
export default async function getGoalByIndicator(roadmapId: string, indicatorParameter: string, unit?: string | undefined | null) {
...
const getCachedGoal = unstable_cache(
  async (roadmapId: string, indicatorParameter: string, unit: string | undefined | null, user) => {
