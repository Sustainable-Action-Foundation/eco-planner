        ...
        <div className="padding-25 smooth flex" style={{ border: "1px solid var(--gray-90)", maxWidth: "48.5rem" }}>
          ...
          <div className="flex flex-direction-column justify-content-center">
            <button
              ...
              onLoad={(e) => updateControlsState((e.target as HTMLElement).parentElement, null, baselineDataSeriesValues)}
              onClick={addColumn}
            >
            ...
            <button
              ...
              onLoad={(e) => updateControlsState(null, (e.target as HTMLElement).parentElement, baselineDataSeriesValues)}
