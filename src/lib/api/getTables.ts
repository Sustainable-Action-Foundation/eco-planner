...
//   let result: Promise<{ id: string; label: string; }[] | null>;
//   if (externalDataset == "SCB") {
//     result = getPxWebTables(externalDataset, searchQuery, language, pageSize);
//   } else if (externalDataset == "Trafa") {
//     // Add logic for Trafa dataset here
//     result = Promise.resolve(null); // Placeholder assignment
//   } else {
//     result = Promise.resolve(null); // Default assignment for other datasets
//   }
