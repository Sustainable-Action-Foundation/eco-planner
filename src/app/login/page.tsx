...
import { createDict } from "./login.dict.ts";
...
export default async function Page() {
  ...
  return (
    <>
      <Breadcrumb customSections={[`${dict.breadcrumbLogin}`]} />
