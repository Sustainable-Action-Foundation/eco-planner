...
import { DataSeriesDataFields, GoalInput, RoadmapInput } from "@/types";
import { Prisma } from "@prisma/client";

export default function roadmapGoalCreator(roadmap: Omit<RoadmapInput, "version"> & { goals?: GoalInput[] }, author: string) {
