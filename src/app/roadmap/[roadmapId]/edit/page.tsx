  ...
  return (
    <>
      ...
      <div className='container-text margin-inline-auto'>
        ...
        <p className="margin-block-300">Menade du att redigera den gemensamma metadatan för alla versioner av den här färdplanen? I så fall kan du <Link href={`/metaRoadmap/${roadmap.metaRoadmapId}/edit`}>gå hit</Link> för att redigera metadatan.</p>
        <RoadmapForm
          user={session.user}
